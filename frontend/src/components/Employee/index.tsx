...
function Employee(data:IEmployee){
        ...
        <EmployeeContainer>
            <EmployeeContent>
                ...
                <EmployeeData>
                    ...
                    <DivItem isDashed isPadding>
                        <span>
                            <h3>D.admissão</h3>
                            <p> {formatDate(new Date(data.admission_date))} </p>
                        </span>

                        <span>
                            <h3> D.nascimento</h3>
                            <p> {formatDate(new Date(data.birth_date))} </p>
                        </span>
                    </DivItem>
                    <DivItem isPadding>
                        <h3> Email</h3>
